---
id: "etl-ingest-normalize-validate"
slug: "etl-ingest-normalize-validate"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Ingestion, Normalization, and Validation Specification

## Stage: intake capture
- Capture governed packet metadata and payload
- Validate front/bottom matter contract shape

## Stage: normalization
- Normalize fields, role ids, contract refs, and evidence refs

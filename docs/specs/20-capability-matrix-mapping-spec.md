---
id: "capability-matrix-mapping"
slug: "capability-matrix-mapping"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Capability Matrix Mapping Specification

## Mapping objective
Create a normalized mapping from capability -> trigger -> placement -> actor -> contract -> evidence.
...
## Capability Matrix Master (inline)

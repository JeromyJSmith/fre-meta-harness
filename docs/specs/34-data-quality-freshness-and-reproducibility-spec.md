---
id: "etl-quality-freshness-repro"
slug: "etl-quality-freshness-repro"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Data Quality, Freshness, and Reproducibility Specification

## Data quality controls
- required fields complete
- contract refs resolvable
- role ids valid

## Freshness controls
- timestamp window checks across metrics/validation/readiness
- stale evidence blocks promotion

## Reproducibility controls
- rerun command must recreate same artifact family and truth boundary

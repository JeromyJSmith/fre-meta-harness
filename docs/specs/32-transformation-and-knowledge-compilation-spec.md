---
id: "etl-transform-compile"
slug: "etl-transform-compile"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Transformation and Knowledge Compilation Specification

## Stage: semantic enrichment
- Derive structured capability features and governance tags

## Stage: feature/capability compilation
- Generate capability-harvest and feature-matrix outputs

## Stage: gap placement synthesis
- Produce gap-placement-map with blocker-aware placement decisions

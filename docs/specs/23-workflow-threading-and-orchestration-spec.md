---
id: "workflow-threading-orchestration"
slug: "workflow-threading-orchestration"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Workflow Threading and Orchestration Specification

## Reusable workflow thread archetypes
1. intake thread
2. routing/delegation thread
3. research compilation thread
4. validation/promotion thread
5. observability/reconciliation thread

## Archetype requirements
- trigger condition
- required tools/capabilities
- input/output contracts
- fail-loud failure behavior
- evidence artifacts

## L5: Workflow topology diagram
```mermaid
flowchart LR
  IT[Intake Thread] --> RD[Routing/Delegation Thread]
  RD --> RC[Research Compilation Thread]
  RC --> VP[Validation/Promotion Thread]
  VP --> OR[Observability/Reconciliation Thread]
  OR --> VP
```

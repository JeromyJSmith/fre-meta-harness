---
id: "etl-storage-index-serving"
slug: "etl-storage-index-serving"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Storage, Indexing, and Serving Specification

## Storage surfaces
- evaluation/research/compiled/*
- evaluation/tool-health/*
- runs/iterations.jsonl

## Indexing and serving
- Runtime API surfaces for queue/routing/delegation views
- Dashboard rendering from service-backed artifacts

## Serving guarantees
- Artifact paths are stable and contract-referenced
- Promotion reads from durable evidence artifacts only

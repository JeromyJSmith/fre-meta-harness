---
id: "ops-rollout-migration-cutover"
slug: "ops-rollout-migration-cutover"
doctype: "spec"
status: "active"
version: "1.0.0"
...
# Rollout, Migration, and Cutover Plan

## Rollout phases
1. Planning baseline lock
2. P0 execution and validation
3. P1 observability/operations integration
4. P2 runtime expansion candidates

## Migration policy
- Preserve same-host truthful baseline during all migrations
- Cross-device remains blocked until exact dependency proof

## Cutover criteria
- Gate pass across validator and readiness
- No unresolved blocker precision violations
- Reproducibility checks pass for promoted lanes
